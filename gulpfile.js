...
var src = {
	sass: "euroimpacto-child/sass/**/*.scss",
	js: 	"euroimpacto-child/js/dev/**/*.js",
	img: 	"src/img/*"
};
...
var output = {
	js: 			"euroimpacto-child/js/script.js",
	css: 			"euroimpacto-child",
	img: 			"output/img",
	html: 		"euroimpacto-child/**/*.php",
   min_css: 	'style.css',
...
gulp.task('watch', function() {
	browserSync.init({
		proxy: "localhost/labs/euroimpacto/",
	});
